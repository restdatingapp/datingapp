        ...
        <>
            ...
            <div className="navi">
                <ul>
                    ...
                    <li><a href="#"><i className="fa fa-tasks" aria-hidden="true"></i><span className="hidden-xs hidden-sm">Messages</span></a></li>
                    ...
                    <li onClick={handleChange}><a href="#"><i className="fa fa-cog" aria-hidden="true"></i><span className="hidden-xs hidden-sm">Settings</span></a></li>
                </ul>
            </div>
        </>
    )
